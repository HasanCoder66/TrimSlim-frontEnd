...
export default function PendingAppTab() {
  const [rows, setRows] = React.useState(initialRows);
  ...
  return (
    <div className='bg-white ml-5 mr-5 mb-5 py-3'>
      <h1 className='text-md font-semibold mx-8'>ALL Appointments</h1>
      <div className='flex justify-end px-8 py-4'>
        <input type="text" className='border focus:outline-none focus:ring-0 focus:border-gray-600' />
        <button className='bg-sky-800 text-white px-2 py-2 '><RiSearchLine /></button>
      </div>
      <Box sx={{ height: 200, width: '97%', backgroundColor: 'white', marginLeft: '18px' }}>
        <DataGrid
          rows={rows}
          columns={columns}
          processRowUpdate={handleProcessRowUpdate}
